      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          ...
          <div className="mb-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button
              onClick={() => {
                const titleInput = document.querySelector<HTMLInputElement>('input[placeholder="What needs to be done?"]');
                titleInput?.focus();
              }}
              className="flex items-center gap-3 p-4 rounded-xl border border-cyan-500/20 bg-gray-800/30 backdrop-blur-sm hover:border-cyan-500/40 hover:bg-gray-800/50 transition-all duration-200 group"
            >
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:from-cyan-500/30 group-hover:to-purple-500/30 transition-all">
